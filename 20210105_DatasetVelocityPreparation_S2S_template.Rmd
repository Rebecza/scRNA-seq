...
source(paste0(workdir,"/src/qc_ercc_384plot.R"))
```
...
spliced.data.df = read_kb_counts(kb.dir, "spliced", barcode_file = barcode_file, replace_bc=F)
...
# # Make a vector with all plate numbers
 ...
 pdf(paste(resultsdir,"PlateDiag_lndscp.pdf",sep="/"), paper = "USr")
