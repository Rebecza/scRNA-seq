...
params:
  ...
  barcode_file: 
    label: "barcode_file -- .tab delimited file with barcode sequences. Use 2-col layout for plate based method"
  ...
  meta_group_id: 
      label: "meta_group_id -- combine meta data fields for plotting. Can be seperated by comma for multiple values" 
      value: Library
  umap_cols: 
      label: "umap_cols -- meta data fields for Seurat's RunUMAP. Can be seperated by comma for multiple values"
      value: Method,Timepoint  
  confounders_to_test: 
      label: "confounders_to_test -- meta data variabel for confounder testing"
      value: Library
  lab_col: 
  ...
  cell_id_subset_filter: 
      label: "cell_id_subset_filter -- perform filtering" 
      choices: ['in', 'out', 'none']
      value: 'none'
  new_col_pattern:
  ...
  pcs_max_hvg: 
      ...
      value: 70
  vars_to_regress:
      label: "vars_to_regress -- variables to perform regression analysis"
