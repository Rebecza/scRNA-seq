...
```{r Perform SCTransform, warning=FALSE}
 ##Perform SCTransform
sct <- SCTransform(seuset, assay = "sf", variable.features.n=params$nhvg, vars.to.regress = params$vars_to_regress_sf, verbose = FALSE)
...
sct_uf <- SCTransform(seuset, assay = "uf", variable.features.n=params$nhvg, vars.to.regress = params$vars_to_regress_uf, verbose = FALSE)
```
